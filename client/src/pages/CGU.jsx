...
function CGU() {
  return (
    <main className=" mt-10 mx-auto w-4/5">
      <h1 className="my-8 text-[var(--secondary-color)]">Conditions Générales d'Utilisation</h1>
      <h2 className="my-8 text-[var(--primary-color)]">1. Bienvenue sur Externatic</h2>
      <p className="my-8">
      ...
      <h2 className="my-8 text-[var(--primary-color)]">3. Inscription et Compte Utilisateur</h2>
      <p className="my-8">
      ...
      <h2 className="my-8 text-[var(--primary-color)]">4. Utilisation du site</h2>
      <p className="my-8">
      ...
      <ul className="my-8 text-lg">
        ...
        <li className="ml-16">Publier des informations fausses ou trompeuses.</li>
        <li className="ml-16">
        ...
        <li className="ml-16">
          Tenter d'obtenir un accès non autorisé aux systèmes informatiques d'Externatic.
        </li>
      </ul>
      <h2 className="my-8 text-[var(--primary-color)]">5. Contenu Utilisateur</h2>
      <p className="my-8">
      ...
      <h2 className="my-8 text-[var(--primary-color)]">7. Protection des Données</h2>
      <p className="my-8">
        7.1. La collecte et le traitement des données personnelles sont régis
        par notre <Link to="/protectionDataPolicy" className="text-[var(--primary-color)]">Politique de Confidentialité</Link>.
      </p>
      <p className="my-8">
      ...
      <h2 className="my-8 text-[var(--primary-color)]">8. Modification des CGU</h2>
      <p>
        {" "}
      ...
      <h2 className="my-8 text-[var(--primary-color)]"> 10. Droit Applicable et Juridiction</h2>
      <p className="my-8">
      ...
      <p className="my-8">
        ...
        Société à l'adresse suivante : Service client, Externatic, 33000 Bordeaux.
      </p>
    </main>
  );
}
