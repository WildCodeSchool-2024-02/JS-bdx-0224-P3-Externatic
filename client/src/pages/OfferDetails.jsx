...
function OfferDetails() {
  ...
  return (
    <main>
        <header className="mt-10 mx-10 relative">

          <img src={offerData.banner} alt="" className="mt-10 w-full h-80 mx-auto " />
          <img src={offerData.logo} alt="" className="w-32 h-32 object-cover z-10 shadow-grey-950 shadow-xl absolute left-10 -bottom-12 border border-[var(--secondary-color)] " />
        </header>
