...
function OfferDetails() {
  ...
  return (
    <main>
      ...
      <h1 className="text-3xl mx-10 mt-16 font-bold  text-[var(--primary-color)] inline-block">{offerData.title}</h1>
      ...
      <li className="ml-10" ><Tag text="REACT" apply="tag" /></li>
      <li className="ml-5" ><Tag text="REACT" apply="tag" /></li>
      <li className="ml-5" ><Tag text="REACT" apply="tag" /></li>
      </ul>
      <h2 className="text-3xl ml-10 my-16 semi-bold text-[var(--primary-color)]">Description du poste</h2>
      <p className="mx-10">
        {offerData.description}
      </p>
      <h2 className="text-3xl ml-10 my-16 semi-bold text-[var(--primary-color)]">Avantages</h2>
      <p className="mx-10" >
        {offerData.advantages}
      </p>
      <h2 className="text-3xl ml-10 my-16 semi-bold text-[var(--primary-color)]">Salaire</h2>
      <p className="mx-10 mb-20" >
        {offerData.salary} Euro/an.
      </p>
      <footer>
