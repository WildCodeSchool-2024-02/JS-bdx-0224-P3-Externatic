...
export default function Values() {
  return (
    <section className="mt-20 mx-4">
      <h2 className="text-[var(--primary-color)] col-span-2 text-center">
        La réussite de notre cabinet recrutement informatique ?
      </h2>
      <article className="flex flex-col relative gap-8 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-10 mt-20">
        <article className="p-4 m-4 md:ml-20 flex flex-col gap-10 bg-[var(--secondary-background-color)] border border-[var(--primary-color)] rounded-md shadow-lg custom-shadow md:max-w-xl">
          <img src={hand} alt="" className="w-20 self-center" />
          <h3 className="text-center">Notre proximité</h3>
        ...
        <article className="p-4 m-4 md:mr-20 flex flex-col gap-10 bg-[var(--secondary-background-color)] border border-[var(--primary-color)] rounded-md shadow-lg custom-shadow md:max-w-xl">
          <img src={hourglass} alt="" className="w-20 self-center" />
          <h3 className="row-start-3 col-start-2 text-center">
            Notre durabilité
          </h3>
        ...
        <article className="p-4 m-4 md:ml-20 flex flex-col gap-10 bg-[var(--secondary-background-color)] border border-[var(--primary-color)] rounded-md shadow-lg custom-shadow md:max-w-xl">
          <img src={rocket} alt="" className="w-20 self-center" />
          <h3 className="row-start-6 col-start-1 text-center">
            Notre performance
          </h3>
        ...
        <article className="p-4 m-4 md:mr-20 flex flex-col gap-10 bg-[var(--secondary-background-color)] border border-[var(--primary-color)] rounded-md shadow-lg custom-shadow md:max-w-xl">
          <img src={calendar} alt="" className="w-20 self-center" />
          <h3 className="row-start-6 col-start-2 text-center">
            Nos Événements
          </h3>
