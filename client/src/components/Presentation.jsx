...
function Presentation() {
  return (
    <main className="flex flex-col items-center">
      ...
      <h2 className="flex-none my-10 mx-6 text-[var(--primary-color)] md:text-4xl md:self-start md:ml-28 md:mt-20">
        Ton prochain job à portée de clicks
      </h2>
      <p className="max-w-prose md:text-lg md:ml-28 mb-10 md:mb-10 md:self-start md:animate-fade-left md:animate-once md:animate-duration-700 md:animate-delay-300">
      ...
      <h2 className="flex-none my-10 text-[var(--primary-color)] md:text-4xl md:self-end md:mr-28 md:mt-20">
        Plus qu’un cabinet de recrutement informatique
      </h2>
      <p className="max-w-prose md:text-lg md:self-end md:mr-44 mx-6 mb-10 md:mb-20 md:text-left md:mx-0 md:animate-fade-right md:animate-once md:animate-duration-700 md:animate-delay-300">
